  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-gold/[0.06] blur-[180px] rounded-full" />
      </div>

      {/* Decorative vertical line running through the center */}
      <div className="absolute top-0 left-1/2 -translate-x-px w-px h-full bg-gradient-to-b from-transparent via-gold/[0.1] to-transparent pointer-events-none hidden lg:block" />

      <div className="max-w-6xl mx-auto px-4 md:px-8">
        {/* Header */}
        <div className="stats-header text-center mb-20 md:mb-28">
          <span
            className="text-gold-dark/70 text-xs tracking-[0.3em] uppercase block mb-4"
          ...
          {STATS.map((stat, i) => {
            ...
            return (
              <div key={stat.label} className="relative">
                ...
                >
                  <span
                    className="stat-ghost-num text-[100px] sm:text-[140px] md:text-[180px] lg:text-[220px] font-bold text-navy/[0.06] leading-none"
                    style={{ fontFamily: "var(--font-mono-custom)" }}
                  >
                    0{stat.suffix}
                  </span>
                ...
                >
                  ...
                  {/* Label */}
                  <p
                    className="text-navy/40 text-[10px] sm:text-xs tracking-[0.25em] uppercase"
                    style={{ fontFamily: "var(--font-mono-custom)" }}
                  >
                    {stat.label}
                  </p>
