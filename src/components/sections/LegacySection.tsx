  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative">
        {/* Top decorative line */}
        <div className="legacy-line-top w-24 h-px bg-emerald/30 mx-auto mb-5 origin-center" />

        {/* Diamond decorations with logo icon */}
        <div className="flex items-center justify-center gap-4 mb-4">
          <div className="legacy-diamond w-1.5 h-1.5 bg-emerald/30 rotate-45 opacity-0" />
          <div className="legacy-diamond w-2 h-2 bg-emerald/40 rotate-45 opacity-0" />
          <svg
        ...
        {/* Section label */}
        <span
          className="legacy-label text-gold-dark text-sm tracking-[0.3em] uppercase block mb-4 opacity-0"
        ...
        >
          ...
          <span className="legacy-title-word inline-block text-emerald opacity-0 mt-1 sm:mt-0">
            EXCELLENCE
          </span>
        </h2>

        {/* Thin divider */}
        <div className="w-16 h-px bg-emerald/20 mx-auto mb-8" />
        ...
        >
          <span className="text-emerald text-[15px] tracking-[0.2em] uppercase font-medium group-hover:tracking-[0.25em] transition-all duration-500">
            Read More
          </span>
          <div className="w-10 h-px bg-emerald/60 group-hover:w-16 transition-all duration-500" />
          <ArrowRight
            size={16}
            className="text-emerald/60 group-hover:translate-x-1 group-hover:text-emerald transition-all duration-300"
          />
        </a>

        {/* Bottom decorative line */}
        <div className="legacy-line-bottom w-24 h-px bg-emerald/30 mx-auto mt-6 origin-center" />
      </div>
    </section>
  );
}
