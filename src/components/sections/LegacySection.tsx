  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative">
        {/* Top decorative line */}
        <div className="legacy-line-top w-24 h-px bg-gold/30 mx-auto mb-5 origin-center" />
        ...
        {/* Bottom decorative line */}
        <div className="legacy-line-bottom w-24 h-px bg-gold/30 mx-auto mt-6 origin-center" />
      </div>
    </section>
  );
}
