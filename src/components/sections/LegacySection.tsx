  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#d3b973]/[0.04] blur-[150px] rounded-full" />
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          <div className="legacy-diamond w-1.5 h-1.5 bg-[#d3b973]/40 rotate-45 opacity-0" />
          <div className="legacy-diamond w-2 h-2 bg-[#d3b973]/50 rotate-45 opacity-0" />
          <svg
        ...
        {/* Section label */}
        <span
          className="legacy-label text-[#d3b973]/70 text-sm tracking-[0.3em] uppercase block mb-4 opacity-0"
        ...
        >
          ...
          <span className="legacy-title-word inline-block text-[#d3b973] opacity-0 mt-1 sm:mt-0">
            EXCELLENCE
          </span>
        </h2>

        {/* Thin golden divider */}
        <div className="w-16 h-px bg-[#d3b973]/30 mx-auto mb-8" />

        {/* Description */}
        <p className="legacy-desc opacity-0 text-white/70 text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-12">
        ...
        >
          <span className="text-[#d3b973] text-sm tracking-[0.2em] uppercase font-medium group-hover:tracking-[0.25em] transition-all duration-500">
            Read More
          </span>
          <div className="w-10 h-px bg-[#d3b973]/60 group-hover:w-16 transition-all duration-500" />
          <ArrowRight
            size={16}
            className="text-[#d3b973]/60 group-hover:translate-x-1 group-hover:text-[#d3b973] transition-all duration-300"
          />
        </a>

        {/* Bottom decorative line */}
        <div className="legacy-line-bottom w-24 h-px bg-[#d3b973]/40 mx-auto mt-6 origin-center" />
      </div>
    </section>
  );
}
