  ...
  return (
    ...
    >
        ...
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="dot-scatter" width="60" height="60" patternUnits="userSpaceOnUse">
              <circle cx="30" cy="30" r="1.2" fill="#950921"/>
      ...
      <div className="absolute top-8 left-8 w-24 h-24 pointer-events-none opacity-25">
        <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#950921] to-transparent" />
        <div className="absolute top-0 left-0 w-[1px] h-full bg-gradient-to-b from-[#950921] to-transparent" />
      ...
      <div className="absolute top-8 right-8 w-24 h-24 pointer-events-none opacity-25">
        <div className="absolute top-0 right-0 w-full h-[1px] bg-gradient-to-l from-[#950921] to-transparent" />
        <div className="absolute top-0 right-0 w-[1px] h-full bg-gradient-to-b from-[#950921] to-transparent" />
      ...
      <div className="absolute bottom-8 left-8 w-24 h-24 pointer-events-none opacity-25">
        <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#950921] to-transparent" />
        <div className="absolute bottom-0 left-0 w-[1px] h-full bg-gradient-to-t from-[#950921] to-transparent" />
      ...
      <div className="absolute bottom-8 right-8 w-24 h-24 pointer-events-none opacity-25">
        <div className="absolute bottom-0 right-0 w-full h-[1px] bg-gradient-to-l from-[#950921] to-transparent" />
        <div className="absolute bottom-0 right-0 w-[1px] h-full bg-gradient-to-b from-[#950921] to-transparent" />
      ...
      {/* Subtle bottom glow */}
      <div className="absolute -bottom-10 right-[20%] w-[500px] h-[300px] bg-[radial-gradient(ellipse_at_center,rgba(149,9,33,0.075)_0%,transparent_60%)] pointer-events-none" />
